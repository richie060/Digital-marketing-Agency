...
<!-- Main content -->
	<div class="content clearfix">
		<div class="main-content single">
			<h2 class="post-title">Why Your Business Needs A Custom Website
Design</h2>
      <div class="post-content">

        <p>Your website is the backbone of your business. It
supports all your company’s digital marketing
efforts and serves as your primary customer
touchpoint. 
        </p>
<p>
A responsive, custom eCommerce
website design gives online users a clear idea of
your brand offerings, unique value propositions and
core values.</p>
<p>
According to a report released by the eCommerce
Foundation, 88 percent of U.S. consumers perform
online research before making a purchase or
visiting a local store. Without a professional custom
website design, online shoppers can get easily
frustrated. 
</p>
<p>
This results in an increased bounce rate,
poor online reputation and lower conversion rate.
Don’t let this be the case for your business.
</p>
<p>
Ensure
your target customers can find and navigate your
website with ease. Invest in a responsive, well designed and informative website to improve your
brand’s profitability and success..</p>
           
           <button class="btn btn-success" name="booking" type="submit" style="margin: 10px auto; float:right; width:80%; font-size=1.8em; ">Book Appointment Now With Us Now</button>
      </div>
		</div>
